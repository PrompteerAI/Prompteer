...
| -------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| ![Image challenge list showing reference metadata](docs/screenshots/19-image-challenges.png) | ![Image challenge detail with prompt execution and reference metadata](docs/screenshots/20-image-challenge-detail.png) |

| Video challenge reference metadata                                                           | Video challenge detail metadata                                                                                        |
| -------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| ![Video challenge list showing reference metadata](docs/screenshots/21-video-challenges.png) | ![Video challenge detail with prompt execution and reference metadata](docs/screenshots/22-video-challenge-detail.png) |
...
| ------------ | ----------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| Google OAuth | `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET`            | Local OIDC provider with seeded admin/paid/free users and JWKS              | [google-oauth.md](docs/integrations/google-oauth.md), verified 2026-05-23 |
| OpenAI       | `OPENAI_API_KEY`, optional `OPENAI_CHAT_MODEL`        | Deterministic Chat Completions responses and SSE chunks                     | [openai.md](docs/integrations/openai.md), verified 2026-05-23             |
| Anthropic    | `ANTHROPIC_API_KEY`, optional `ANTHROPIC_MODEL`       | Deterministic Messages responses and Anthropic-shaped SSE events            | [anthropic.md](docs/integrations/anthropic.md), verified 2026-05-23       |
| Stripe       | `STRIPE_SECRET_KEY`; webhook: `STRIPE_WEBHOOK_SECRET` | Checkout Session create/retrieve/expire/complete with local webhook signing | [stripe.md](docs/integrations/stripe.md), verified 2026-05-23             |
| SendGrid     | `SENDGRID_API_KEY`                                    | Mail Send validation, `.eml` capture, and `/dev/mailbox` viewer             | [sendgrid.md](docs/integrations/sendgrid.md), verified 2026-05-23         |
